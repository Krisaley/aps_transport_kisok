...
class MovementDocumentService
{
    ...
    public function issue(Movement $movement, string $type, User $user): MovementDocument
    {
        ...
        $movement->load(['company.homeSite', 'customer', 'actions.site', 'actions.driver', 'actions.vehicle', 'items.accessories', 'items.collectionAction.site', 'items.deliveryAction.site', 'photos']);
