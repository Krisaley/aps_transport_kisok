...
{
    public function preview(Request $r, Movement $movement, string $type)
    {
    ...
    public function issue(Request $r, Movement $movement, string $type, MovementDocumentService $service)
    {
    ...
    public function download(Request $r, MovementDocument $document)
    {
