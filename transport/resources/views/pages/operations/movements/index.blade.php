...
<section class="w-full p-6">
    ...
    <x-pages::operations.layout contentclass="max-w-6xl">
        <div class="mb-4 flex flex-wrap gap-2">
            ...
            <flux:select wire:model.live="typeFilter"><flux:select.option value="all">{{ __('All types') }}</flux:select.option><flux:select.option value="delivery">{{ __('Delivery') }}</flux:select.option><flux:select.option value="collection">{{ __('Collection') }}</flux:select.option><flux:select.option value="exchange">{{ __('Exchange') }}</flux:select.option></flux:select>
