...
new #[Title('Create Customer')] class extends Component {
    ...
    public function save()
    {
        ...
        return $this->redirectRoute('setup.customers.index', navigate: true);
    }
    ...
    <x-pages::setup.layout
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                ...
                <flux:button variant="ghost" :href="route('setup.customers.index')" wire:navigate>{{ __('Back') }}</flux:button>
            </div>
            ...
            <form wire:submit="save" class="space-y-6">
                ...
                <div class="flex justify-end gap-3">
                    <flux:button variant="ghost" :href="route('setup.customers.index')" wire:navigate>{{ __('Cancel') }}</flux:button>
